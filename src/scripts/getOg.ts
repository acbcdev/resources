  ...
  try {
    ...
    const og = await page.evaluate(() => {
      return {
        ...
        descripcion: document.querySelector('meta[property="og:description"]')?.getAttribute('content') || undefined,
        type: document.querySelector('meta[property="og:type"]')?.getAttribute('content') || undefined,
        site_name: document.querySelector('meta[property="og:site_name"]')?.getAttribute('content') || undefined,
        video: document.querySelector('meta[property="og:video"]')?.getAttribute('content') || undefined,
        icon: document.querySelector('link[rel="icon"]')?.getAttribute('href') || undefined
      }
    })
    return og
  }
